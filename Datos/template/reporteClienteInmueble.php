...
$query = "SELECT c.ID_CLIENTE,c.NUM_IDENTIFICACION, c.PNOMBRE_CLIENTE, c.PAPELLIDO_CLIENTE, i.ID_INMUEBLE, i.SALDO_INMUEBLE
FROM inmueble i
JOIN cliente c ON i.ID_CLIENTE = c.ID_CLIENTE
WHERE i.SALDO_INMUEBLE > 0;";
...
<center>
    <div class="contenedor">
        <div id="bd">
            <input type="button" onclick="exportTableToExcel('reporte','reporteClienteInmueble')" value="Generar Excel" class="btn btn-success mt-3" > <br>
            <table class="table table-striped table-bordered text-center  w-75 mt-3" id="reporte">
                ...
                while ($cliente = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td scope="row"><?php echo $cliente['ID_INMUEBLE']; ?></td>
                        <td scope="row"><?php echo $cliente['SALDO_INMUEBLE']; ?></td>
                    </tr>
                <?php }
